package trc.recursos.controlador;
...
import trc.recursos.excepcion.RecursoNoEncontradoExcepcion;
import trc.recursos.modelo.Empleado;
import trc.recursos.servicio.IEmpleadoServicio;
...
public class EmpleadoControlador {
    ...
    public Empleado agregarEmpleado(@RequestBody Empleado empleado){
        logger.info("Epleado a agregar: " + empleado);
